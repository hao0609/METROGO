      ...
      <section class="section" ref="section">
        <ol>
          ...
          <li
            ...
            :key="question.id"
            :class="[
              { yellow_active: question.id === activeQuestionId },
      ...
      <div class="mission-main">
        ...
        >
          ...
          <div class="metro_station_id_n">
            ...
            <p><span class="list yellow">審核條件</span> {{ line.message }}</p>
            <img
              v-if="line.img"
              :src="line.img"
              alt="Station Image"
              class="station-img yellow_shadow"
            />
            <div v-else class="no-photo yellow yellow_shadow">
        ...
        <div ref="questionSection">
          ...
          >
            <div class="title article">
              ...
              <div class="station-img question-icon yellow yellow_shadow">
                <div
                  v-if="question.icon"
                  class="question-icon"
