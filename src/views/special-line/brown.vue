    ...
    <div class="mission-content">
      <section ref="section">
        ...
        <ol :class="{ section_active: sectionActive }">
          <li
            class="station title1 brown"
            v-for="station in stations"
            :key="station.id"
            :class="[
              { brown_active: station.id === activeStationId },
              {
                'brown-line': lines.find((line) => line.id === station.id)?.img,
              },
            ]"
          >
          ...
          <li
            ...
            :key="question.id"
            :class="[
              { brown_active: question.id === activeQuestionId },
              { 'brown-answered': isanswered },
            ]"
          >
