<script setup>
    ...
    const { pinStyle_brown } = pinjs();                             // 使用 pin.js 的 pin()
...
<template>
    ...
    <div class="hitarea">
        <!-- <button ref="pin_obj" class="pin" :style="pinStyle_brown" @click="UserLocationShowAlert" @touchstart="UserLocationShowAlert" ><pin/></button> -->
    </div>
