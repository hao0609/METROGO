  ...
  <section class="products">
          <div class="products-wrapper">
            <div class="section-header">
              <h2>最新商品</h2>
              <button class="view-more" @click.prevent="handleViewMoreProducts">查看更多</button>
            </div>
            <div class="product-list">
              <div v-for="product in products" :key="product.id" class="product-card">
                ...
                <div class="product-actions">
                  <button class="action-btn" title="收藏" @click.prevent="handleAddToWishlist(product)">❤️</button>
                  <button class="action-btn" title="加入購物車" @click.prevent="handleAddToCart(product)">🛒</button>
