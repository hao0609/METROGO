<script setup>
import { ref } from 'vue'
import alert_web_L from '../Alert_web_L.vue';
...
const AlertInfo = {
    ...
    rowData1: {
        ...
        Text: "This is a dynamic message passed from the parent component.This is a dynamic message passed from the parent component.",
        ImgSrc: sampleImg,
    },
    rowData2 :{
    Title2: "Title2 (Optional)",
...
const Alert_L_template_ShowAlert = () => {
    alert_web_L_content.value.showAlert();
}

defineExpose({                                                // 暴露 Alert_L_template_ShowAlert 方法給父組件使用
    Alert_L_template_ShowAlert,
});
</script>


<template>
    <alert_web_L ref="alert_web_L_content" :alertInfo="AlertInfo"/>
</template>
